...
class TestAndroidNotifyFull(unittest.TestCase):
    ...
    def test_simple(self):
        try:
            n = Notification(title="Simple", message="Simple message test")
            n.send()
    ...
    def test_progress(self):
        try:
            n = Notification(title="Downloading...", message="0% downloaded", progress_current_value=0, progress_max_value=100)
            n.send()
    ...
    def test_big_picture(self):
        try:
            n = Notification(title="Big Picture", message="Testing big picture")
    ...
    def test_inbox(self):
        try:
            n = Notification(title="Inbox", message="Inbox notification")
    ...
    def test_inbox_from_file_message(self):
        try:
            lines = "Test1\nTest2\nTest3"
            n = Notification(title="Inbox File", message="File Inbox Test", lines_txt=lines)
            n.send()
        except Exception as e:
    ...
    def test_inbox_add_line(self):
        try:
            n = Notification(title="Inbox AddLine", message="Testing addLine()")
    ...
    def test_large_icon(self):
        try:
            n = Notification(title="Large Icon", message="Testing large icon")
    ...
    def test_big_text(self):
        try:
            n = Notification(title="Big Text", message="Testing big text")
    ...
    def test_buttons(self):
        try:
            n = Notification(title="With Buttons", message="Testing action buttons")
    ...
    def test_both_imgs(self):
        try:
            n = Notification(title="Both Images", message="Testing both large & big picture")
            n.setLargeIcon("assets/icon.png")
            n.setBigPicture("assets/icon.png")
            n.send()
        except Exception as e:
    ...
    def test_custom_icon(self):
        try:
            n = Notification(title="Custom Icon", message="Testing custom app icon")
    ...
    def test_title_message_update(self):
        try:
            n = Notification(title="Old Title", message="Old Message")
            n.send()
            time.sleep(2)
    ...
    def test_custom_id(self):
        try:
            n = Notification(title="Custom ID", message="Click to trigger handler", name="change_app_page")
            n.send()
        except Exception as e:
    ...
    def test_callback(self):
        try:
            n = Notification(title="With Callback", message="Tap to run callback", callback=lambda: print("Callback invoked"))
            n.send()
        except Exception as e:
    ...
    def test_custom_channel_name(self):
        try:
            n = Notification(title="Custom Channel", message="Testing custom name", channel_name="MyChannelName")
            n.send()
        except Exception as e:
    ...
    def test_create_channel_lifespan(self):
        try:
            n = Notification(title="Check ID Lifespan", message="Testing channel id reuse")
            cid = "test_channel_id"
    ...
    def test_persistent(self):
        try:
            n = Notification(title="Persistent", message="This notification should persist")
